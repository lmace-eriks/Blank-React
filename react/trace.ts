export const trace = (string: string) => {
    console.log("%c" + string, "display: block; width: 50%; margin: auto; background-color: blue; color: white; font-weight: bold; font-size: 20px; text-align: center; padding: 10px;");
}
